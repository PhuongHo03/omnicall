...
class Settings(BaseSettings):
    ...
    voice_ffmpeg_path: str = Field(default="ffmpeg", alias="VOICE_FFMPEG_PATH")
    voice_work_dir: str = Field(default="/tmp/omnicall-audio", alias="VOICE_WORK_DIR")
    ...
    asr_model: str = Field(default="whisper-small-int8", alias="ASR_MODEL")
    ...
    rerank_command: str = Field(default="", alias="RERANK_COMMAND")
