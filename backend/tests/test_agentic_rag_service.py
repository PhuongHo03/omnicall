...
from backend.services.agentic_rag_service import (
    AgentResult,
    AgenticRAGService,
    _VALID_TOOLS,
...
from backend.services.fast_path_handler import FastPathResponse
from backend.services.retrieval_search_service import RetrievedChunk
...
class AgenticRAGServiceTestCase(unittest.TestCase):
    ...
    def test_token_manager_integration(self) -> None:
        ...
        from backend.services.token_management import TokenManager
    ...
    def test_fast_path_handler_integration(self) -> None:
        ...
        from backend.services.fast_path_handler import FastPathHandler
