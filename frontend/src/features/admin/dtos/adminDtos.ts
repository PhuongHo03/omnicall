...
function parseAdminOperationalLog(raw: unknown): AdminOperationalLog {
  ...
  return {
    ...
    executorType: nullableString(raw.executorType, "log.executorType"),
    resource: nullableString(raw.resource, "log.resource"),
    operation: nullableString(raw.operation, "log.operation"),
    version: nullableString(raw.version, "log.version"),
    configuredProvider: nullableString(raw.configuredProvider, "log.configuredProvider"),
    configuredModel: nullableString(raw.configuredModel, "log.configuredModel"),
    effectiveProvider: nullableString(raw.effectiveProvider, "log.effectiveProvider"),
    effectiveModel: nullableString(raw.effectiveModel, "log.effectiveModel"),
    originProvider: nullableString(raw.originProvider, "log.originProvider"),
    originModel: nullableString(raw.originModel, "log.originModel"),
